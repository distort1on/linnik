...
"")
    ...
    def retranslateUi(self, Form):
        ...
        self.label_4.setToolTip(QCoreApplication.translate("Form", u"X_Shift", None))
...
#if QT_CONFIG(tooltip)
        self.label_5.setToolTip(QCoreApplication.translate("Form", u"Y_Shift", None))
#endif // QT_CONFIG(tooltip)
        self.label_5.setText(QCoreApplication.translate("Form", u"d:", None))
#if QT_CONFIG(tooltip)
        self.label_2.setToolTip(QCoreApplication.translate("Form", u"Y_Stretching", None))
#endif // QT_CONFIG(tooltip)
        self.label_2.setText(QCoreApplication.translate("Form", u"a:", None))
        self.label_13.setText(QCoreApplication.translate("Form", u"Width:", None))
#if QT_CONFIG(tooltip)
        self.label_3.setToolTip(QCoreApplication.translate("Form", u"X_Stretching", None))
#endif // QT_CONFIG(tooltip)
        ...
        self.math_graphic_type_edit.setItemText(0, QCoreApplication.translate("Form", u"ln", None))
        self.math_graphic_type_edit.setItemText(1, QCoreApplication.translate("Form", u"sin", None))
        self.math_graphic_type_edit.setItemText(2, QCoreApplication.translate("Form", u"exp", None))
        self.math_graphic_type_edit.setItemText(3, QCoreApplication.translate("Form", u"tan", None))
        self.math_graphic_type_edit.setItemText(4, QCoreApplication.translate("Form", u"atan", None))
