...
"")
    ...
    def retranslateUi(self, Form):
        ...
        self.label_9.setToolTip(QCoreApplication.translate("Form", u"Defect height", None))
#endif // QT_CONFIG(tooltip)
        self.label_9.setText(QCoreApplication.translate("Form", u"Height (mcm):", None))
#if QT_CONFIG(tooltip)
        self.label_11.setToolTip(QCoreApplication.translate("Form", u"Defect width", None))
#endif // QT_CONFIG(tooltip)
        self.label_11.setText(QCoreApplication.translate("Form", u"Width (mm):", None))
#if QT_CONFIG(tooltip)
        self.label_12.setToolTip(QCoreApplication.translate("Form", u"Shift of the function along the OY axis", None))
#endif // QT_CONFIG(tooltip)
        self.label_12.setText(QCoreApplication.translate("Form", u"b (mm):", None))
#if QT_CONFIG(tooltip)
        self.label_10.setToolTip(QCoreApplication.translate("Form", u"<html><head/><body><p>Responsible for the approximation of the function to the axis OY</p><p>(Stretching)</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
