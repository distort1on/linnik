...
################################################################################
## Form generated from reading UI file 'defect_section_2_ui.ui'
##
...
"")
        ...
        self.y_center_edit.setMaximum(0.100000000000000)
        self.y_center_edit.setSingleStep(0.010000000000000)
        self.y_center_edit.setValue(0.000000000000000)
        ...
        self.x_center_edit.setMaximum(0.100000000000000)
        self.x_center_edit.setSingleStep(0.010000000000000)
        self.x_center_edit.setValue(0.000000000000000)

        self.gridLayout.addWidget(self.x_center_edit, 0, 1, 1, 1)

        self.giperbola_b_edit = QDoubleSpinBox(self.layoutWidget)
        self.giperbola_b_edit.setObjectName(u"giperbola_b_edit")
        self.giperbola_b_edit.setMinimum(0.030000000000000)
        self.giperbola_b_edit.setMaximum(0.200000000000000)
        self.giperbola_b_edit.setSingleStep(0.010000000000000)
        self.giperbola_b_edit.setValue(0.100000000000000)

        self.gridLayout.addWidget(self.giperbola_b_edit, 3, 1, 1, 1)

        self.giperbola_a_edit = QDoubleSpinBox(self.layoutWidget)
        self.giperbola_a_edit.setObjectName(u"giperbola_a_edit")
        self.giperbola_a_edit.setMinimum(0.030000000000000)
        self.giperbola_a_edit.setMaximum(0.200000000000000)
        self.giperbola_a_edit.setSingleStep(0.010000000000000)
        self.giperbola_a_edit.setValue(0.100000000000000)

        self.gridLayout.addWidget(self.giperbola_a_edit, 2, 1, 1, 1)
    ...
    def retranslateUi(self, Form):
        Form.setWindowTitle(QCoreApplication.translate("Form", u"Hyperbola", None))
        self.label.setText(QCoreApplication.translate("Form", u"Hyperbola", None))
        self.label_5.setText(QCoreApplication.translate("Form", u"b:", None))
        self.label_3.setText(QCoreApplication.translate("Form", u"Y_Center:", None))
        ...
        self.label_2.setText(QCoreApplication.translate("Form", u"X_Center:", None))
